...
global.email = 'maxaustin37@gmail.com'
global.github = 'https://wa.me/265997133051'
global.location = 'Malawi'
global.gurl = 'https://wa.me/265997133051' // add your username
global.sudo = process.env.SUDO || '265997133051'
global.devs = '265997133051';
global.website = 'https://wa.me/265997133051' // Hello world
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/d0fdb53f9f22eefd486cb.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'MAXBOT-MD' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'AUSTIN_MAX' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'AUSTINMAX' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'false' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'MAXBOT-MD' : process.env.PACK_NAME.split(";")[1],
